...
const CODES_BY_STEP = {
  ...
  abilities: ["ABILITY_METHOD_MISSING", "ABILITY_METHOD_NOT_ALLOWED", "ABILITY_SCORES_MISSING", "POINT_BUY_INVALID",
    "STANDARD_ARRAY_INVALID", "ROLL_INVALID"],
  ...
  details: ["NAME_REQUIRED", "DETAIL_INVALID"],
